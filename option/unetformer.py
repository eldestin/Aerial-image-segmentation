...
from utils.process import Lookahead
from utils.process import process_model_params
from utils.losses import *
from dataset.uavid_dataset import *
from models.img_seg_model.UNetFormer import UNetFormer
# training hparam
max_epoch = 40
ignore_index = 255
train_batch_size = 8
...
train_dataset = UAVIDDataset(data_root='C:/Users/Franklin/code/Aerial image segmentation/Code/data/uavid/uavid_train_val', img_dir='images', mask_dir='masks',
